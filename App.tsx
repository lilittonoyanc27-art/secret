...
import GameView from './ErnestoGameView';
    ...
    <div className="flex flex-col items-center gap-12 sm:gap-20 py-12 sm:py-24 text-center px-4">
      <div className="text-center space-y-6 max-w-3xl relative">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl xs:text-5xl sm:text-8xl md:text-9xl font-black text-slate-950 tracking-tighter uppercase italic leading-none">
            ԷՌՆԵՍՏՈՅԻ <br/><span className="text-amber-500">ԳԱՂՏՆԻՔԸ</span>
          </h1>
          <p className="text-xs sm:text-2xl md:text-3xl font-bold text-amber-600 uppercase tracking-[0.2em]">
            ԷՌՆԵՍՏՈ ԴԵ ՌԱՄԻՐԵՍ ԴԵ ՍԱԱՎԵԴՐԱ
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-xl space-y-6">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-slate-900 text-left">
            ...
            <div className="space-y-1 flex-1">
              ...
              <p className="text-slate-400 text-sm sm:text-base font-bold italic leading-tight">Սովորիր Hablar, Decir, Oír և Escuchar:</p>
            </div>
        ...
        <motion.button
          ...
          className="group relative w-full overflow-hidden bg-stone-900 p-8 sm:p-12 rounded-[40px] shadow-2xl border-b-[12px] border-stone-950"
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-white text-left">
            ...
            <div className="space-y-1 flex-1">
              <h3 className="text-2xl sm:text-4xl font-black italic uppercase tracking-tighter leading-tight group-hover:text-amber-400 transition-colors">ԲԱՑԻՐ ՍՆԴՈՒԿԸ</h3>
              <p className="text-white/40 text-sm sm:text-base font-bold italic leading-tight">Գտիր Էռնեստոյի թաքնված ոսկին:</p>
            </div>
